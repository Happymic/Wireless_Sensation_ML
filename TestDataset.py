...
class TestDataset(Dataset):
    def __init__(self):
        super().__init__()
        self.max_length = 1000  # 数据集设置最大序列长度
    ...
    def _get_data(self):
        ...
        csi_files = ['/Users/michaelli/Downloads/Score/房间A/csi_2023_10_31_3.txt']
        csi_files_1 = ['/Users/michaelli/Downloads/Score/房间A/csi_2023_10_31_3.txt']
        csi_labels = ['/Users/michaelli/Downloads/AP_Left/truth/csi_2023_10_20_4_truth.txt']
        csi_labels_1 = ['/Users/michaelli/Downloads/AP_Left/truth/csi_2023_10_20_4_truth.txt']
    ...
    def _get_matrix(self, csi_file, csi_label=None):
        ...
        for i, line in enumerate(lines):
            ...
            rssi = list(map(int, data[3:5]))
            ag = list(map(int, data[5:8]))
            csi = [complex(data[i].replace('i', 'j')) for i in range(8, len(data))]
    ...
    def _get_matrix_1(self, csi_file_1, csi_label=None):
        ...
        sample_point = int(len(data) / 1008)
        time = []
        rssi = []
        agc = []
        csi = []
        ...
        for i in range(sample_point):
            time.append(data[i * 1008:i * 1008 + 3])
            rssi.append(data[i * 1008 + 3:i * 1008 + 5])
            agc.append(data[i * 1008 + 6:i * 1008 + 7])
            csi.append([complex(data[x]) for x in range(i * 1008 + 8, (i + 1) * 1008)])
